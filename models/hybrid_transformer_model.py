...
class HybridTransformer_Portfolio(tf.keras.layers.Layer):
    ...
    def Transformer_Model(self):
        ...
        X = tf.keras.layers.LSTM(units = 256, dropout = self.dropout, return_sequences = True)(Input)
        #Transformer architecture is implemented
        transformer_block_1 = TransformerBlock(embed_dim = 256, num_heads=self.headsAttention, ff_dim = 8, rate = self.dropout, )
